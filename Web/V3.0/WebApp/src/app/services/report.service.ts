...
export class ReportService {
  ...
  getReportTrafficByTime(selectedDate: String, storeID: number, timeFrom: String, timeTo: String): Observable<any[]> {
    return this.http.get<any[]>(this.reportUrl + 'getReportTrafficByTime/' + selectedDate + '/'
                                                                       + storeID + '/'
                                                                       + timeFrom + '/'
                                                                       + timeTo);
  }
  ...
  getReportTrafficByMonth(selectedMonth: String, storeID: number): Observable<any[]> {
    return this.http.get<any[]>(this.reportUrl + 'getReportTrafficByMonth/' + selectedMonth + '/' + storeID);
  }
