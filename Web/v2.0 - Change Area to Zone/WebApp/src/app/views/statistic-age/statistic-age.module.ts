...
import { StatisticAgeRoutingModule } from './statistic-age-routing.module';
...
@NgModule({
  ...
  declarations: [ StatisticAgeComponent, MonthyearpickerComponent, FulldatepickerComponent],
  providers: [  ]
})
