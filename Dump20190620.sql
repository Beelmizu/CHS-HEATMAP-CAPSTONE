...
INSERT INTO `account` VALUES (1,'cuongdq','12345','Do Cuong','qcuong2511@gmail.com',0,'0904635563',1,'2019-06-12T12:35:06.732',NULL,'active',NULL,1),(2,'camdq','1234','Do Quoc Cam','qcam123@gmail.com',0,'01213855665',0,'2019-06-12T12:35:53.780',NULL,'active',NULL,2),(3,'tannm','1234','Ngo Minh Tan','tannm@gmail.com',0,'01213744556',0,'2019-06-12T12:36:34.703',NULL,'inactive',NULL,1),(4,'cuongpg1','1234','Phan Gia Cuong','cuongpg123@gmail.com',0,'01252266332',0,'2019-06-12T12:37:16.409','2019-06-12T12:37:40.947','active','cuongdq',2);
...
CREATE TABLE `account_store` (
  ...
  `acc_sto_status` varchar(10) DEFAULT NULL,
...
INSERT INTO `account_store` VALUES (1,'2019-06-12T12:35:06.732',NULL,'active',NULL,2,1),(2,'2019-06-12T12:35:06.732',NULL,'deactive',NULL,2,2),(3,'2019-06-12T12:35:06.732',NULL,'active',NULL,3,2),(4,'2019-06-12T12:35:06.732',NULL,'active',NULL,2,3);
...
CREATE TABLE `report` (
  ...
  `rep_area_id` int(11) NOT NULL,
  PRIMARY KEY (`rep_id`),
  KEY `rep_area_id_idx` (`rep_area_id`),
  CONSTRAINT `rep_area_id` FOREIGN KEY (`rep_area_id`) REFERENCES `area` (`area_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-06-20 22:59:36
